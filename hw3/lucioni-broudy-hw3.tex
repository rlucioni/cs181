	...
	\item
		\begin{enumerate}
			...
			The requested table and scatterplot are below. \\
				...
				We expect the centroid metric to grow convex structures and for those structures to be less effected by outliers. We also expect them to be relatively similar because they are compromises between min and max. This aligns relatively well with what we see in the graph above.
